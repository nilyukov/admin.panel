...
Route::middleware(['status', 'auth'])->group(function () {
    ...
    Route::group($groupData, function () {
        ...
        Route::post('/products/gallery', 'ProductController@gallery')->name('blog.admin.products.gallery');
        Route::post('/products/delete-gallery', 'ProductController@deleteGallery')->name('blog.admin.products.deletegallery');
        Route::get('/products/return-status/{id}', 'ProductController@returnStatus')->name('blog.admin.products.returnstatus');
        Route::get('/products/delete-status/{id}', 'ProductController@deleteStatus')->name('blog.admin.products.deletestatus');
        Route::get('/products/delete-product/{id}', 'ProductController@deleteProduct')->name('blog.admin.products.deleteproduct');

        Route::resource('products', 'ProductController')->names('blog.admin.products');
        ...
        Route::match(['get', 'post'], '/currency/add', 'CurrencyController@currencyAdd');
        Route::match(['get', 'post'], '/currency/edit/{id}', 'CurrencyController@currencyEdit');
...
Route::get('user/index', 'Blog\User\MainController@index')->middleware('auth');
